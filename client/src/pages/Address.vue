...
<div>
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                ...
                <li class="addr-new" @click="addNewConfirm">
    ...
    <modal :mdShow="addShow" @close="closeModalAdd">
        <p slot="message">
            添加新的地址</br>
            姓名：<input type="text" name="" id="" v-model="address.userName"></br>
            地址：<input type="text" name="" id="" v-model="address.streetName"></br>
            邮编：<input type="text" name="" id="" v-model="address.postCode"></br>
            电话：<input type="text" name="" id="" v-model="address.tel"></br>
            是否默认：<input type="checkbox" v-model="address.isDefault">
        </p>
        <div slot="btnGroup">      
            <a class="btn btn--m" href="javascript:;" @click="addAddress" >确认</a>
            <a class="btn btn--m btn--red" href="javascript:;" @click="addShow=false">取消</a>
        </div>
    </modal>
</div>
</template>
